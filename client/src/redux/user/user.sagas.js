...
export function* signInWithEmailAndPasswordStart(){
    yield takeLatest(userActionTypes.EMAIL_SIGN_IN_START, signInWithEmailAndPasswordAsync)
}
...
export function* userSagas(){
    yield all([call(signInWithGoogleStart),
        ...
        call(onCheckUserSession), call(onSignOut),
    call(onSignUpStart),
